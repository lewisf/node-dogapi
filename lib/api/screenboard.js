 ...
 *params:
 *  board_title: the name of the screenboard
 ...
 *    title, description, widgets, options,
 *    function(err, res){
 *      console.dir(res);
 *    }
 *  );
 *  ```
 */
function create(title, widgets, options, callback){
...
module.exports = {
    ...
    getUsage: function(){
        return [
            "  dogapi screenboard create <title> <widgets> [--description <description>] [--tmpvars <templateVariables>] [--width <width>] [--height <height>]",
