 ...
 *  };
 *  dogapi.initialize(options);
 *  dogapi.screenboard.update(1234, {
 *    width: 1024,
 *    length: 768,
 *    board_title: 'dog api test',
 *    widgets: [
 *      "type": "query_value",
 *      "height": 9,
 *      "width": 18,
 ...
 *  });
 */
function update(boardId, data, callback){
  client.request("PUT", util.format("/screen/%s", boardId), {body: data}, callback);
}
